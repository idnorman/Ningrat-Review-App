                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>List Contact dan Detail Restoran</h5>
                                        </div>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>1</td>
                                                            <td>Whatsapp</td>
                                                            <td>wa.me/0810231023</td>
                                                            <td><a href="https://wa.me/0810231023" target="_blank">Preview</a></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>2</td>
                                                            <td>Instagram</td>
                                                            <td>intagram.com/ningrat</td>
                                                            <td><a href="intagram.com/ningrat" target="_blank">Preview</a></td>
                                                            <td>
                                                                <button class="btn btn-primary btn-sm">Edit</button>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>3</td>
                                                            <td>Google maps</td>
                                                            <td>https://maps.app.goo.gl/McJkjTazEsHiLpPg8</td>
                                                            <td><a href="intagram.com/ningrat" target="_blank">Preview</a></td>
                                                            <td>
                                                                <button class="btn btn-primary btn-sm">Edit</button>
                                                            </td>
