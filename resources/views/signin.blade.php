	...
	<div class="auth-content container">
		<div class="card">
			<div class="row align-items-center">
				<div class="col-md-6">
					<div class="card-body">
						<img src="{{ asset ('Admin/images/logo.png') }}" alt="Logo" class="img-fluid mb-2 w-25 h-25">
						<h4 class="mb-3 f-w-400">Login Page Administrator</h4>
						...
						<form id="form-login">
							...
							<button class="btn btn-outline-danger mb-4">Login</button>
						</form>
						<p class="mb-2 text-muted">Forgot password? <a href="{{ route('forgot-password') }}" class="f-w-400">Reset</a></p>
					</div>
				</div>
				<div class="col-md-6 d-none d-md-block">
					<img src="{{ asset('Admin/images/interior.jpg') }}" alt="" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
